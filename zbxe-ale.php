<?php
/* Utilizei como base inicial para o desenvolvimento o "auditlogs.php" e alguns outros arquivos do Frontend do Zabbix
** Objetivo: Possibilitar maior granularidade na pesquisa dos logs de auditoria
