 ...
 *
 * @version     $Id: ZabbixApiAbstract.class.php 136 2012-08-20 18:37:34Z dbarton $
 */
...
abstract class ZabbixApiAbstract
{
    ...
    public function alertCreate($params=array(), $arrayKeyProperty='')
    {
        // get params array for request
        $params = $this->getRequestParamsArray($params);

        // request
        return $this->request('alert.create', $params, $arrayKeyProperty);
    }
    ...
    public function alertDelete($params=array(), $arrayKeyProperty='')
    {
        // get params array for request
        $params = $this->getRequestParamsArray($params);

        // request
        return $this->request('alert.delete', $params, $arrayKeyProperty);
    }
    ...
    public function eventCreate($params=array(), $arrayKeyProperty='')
    {
        // get params array for request
        $params = $this->getRequestParamsArray($params);

        // request
        return $this->request('event.create', $params, $arrayKeyProperty);
    }
    ...
    public function eventDelete($params=array(), $arrayKeyProperty='')
    {
        // get params array for request
        $params = $this->getRequestParamsArray($params);

        // request
        return $this->request('event.delete', $params, $arrayKeyProperty);
    }
    
    /**
     * @brief   Reqeusts the Zabbix API and returns the response of the API
     *          method event.deleteByTriggerIDs.
     *
     * The $params Array can be used, to pass through params to the Zabbix API.
     * For more informations about this params, check the Zabbix API
     * Documentation.
    ...
    public function eventDeleteByTriggerIDs($params=array(), $arrayKeyProperty='')
    {
        // get params array for request
        $params = $this->getRequestParamsArray($params);

        // request
        return $this->request('event.deleteByTriggerIDs', $params, $arrayKeyProperty);
    }
    ...
    /**
     * @brief   Reqeusts the Zabbix API and returns the response of the API
     *          method triggerexpression.checkExpression.
     *
     * The $params Array can be used, to pass through params to the Zabbix API.
     * For more informations about this params, check the Zabbix API
     * Documentation.
    ...
    public function triggerexpressionCheckExpression($params=array(), $arrayKeyProperty='')
    {
        // get params array for request
        $params = $this->getRequestParamsArray($params);

        // request
        return $this->request('triggerexpression.checkExpression', $params, $arrayKeyProperty);
    }
    
    /**
     * @brief   Reqeusts the Zabbix API and returns the response of the API
     *          method triggerexpression.checkMacro.
     *
     * The $params Array can be used, to pass through params to the Zabbix API.
     * For more informations about this params, check the Zabbix API
     * Documentation.
    ...
    public function triggerexpressionCheckMacro($params=array(), $arrayKeyProperty='')
    {
        // get params array for request
        $params = $this->getRequestParamsArray($params);

        // request
        return $this->request('triggerexpression.checkMacro', $params, $arrayKeyProperty);
    }
    
    /**
     * @brief   Reqeusts the Zabbix API and returns the response of the API
     *          method triggerexpression.checkUserMacro.
     *
     * The $params Array can be used, to pass through params to the Zabbix API.
     * For more informations about this params, check the Zabbix API
     * Documentation.
    ...
    public function triggerexpressionCheckUserMacro($params=array(), $arrayKeyProperty='')
    {
        // get params array for request
        $params = $this->getRequestParamsArray($params);

        // request
        return $this->request('triggerexpression.checkUserMacro', $params, $arrayKeyProperty);
    }
    
    /**
     * @brief   Reqeusts the Zabbix API and returns the response of the API
     *          method triggerexpression.checkHost.
     *
     * The $params Array can be used, to pass through params to the Zabbix API.
     * For more informations about this params, check the Zabbix API
     * Documentation.
    ...
    public function triggerexpressionCheckHost($params=array(), $arrayKeyProperty='')
    {
        // get params array for request
        $params = $this->getRequestParamsArray($params);

        // request
        return $this->request('triggerexpression.checkHost', $params, $arrayKeyProperty);
    }
    
    /**
     * @brief   Reqeusts the Zabbix API and returns the response of the API
     *          method triggerexpression.checkItem.
     *
     * The $params Array can be used, to pass through params to the Zabbix API.
     * For more informations about this params, check the Zabbix API
     * Documentation.
    ...
    public function triggerexpressionCheckItem($params=array(), $arrayKeyProperty='')
    {
        // get params array for request
        $params = $this->getRequestParamsArray($params);

        // request
        return $this->request('triggerexpression.checkItem', $params, $arrayKeyProperty);
    }
    
    /**
     * @brief   Reqeusts the Zabbix API and returns the response of the API
     *          method triggerexpression.checkFunction.
     *
     * The $params Array can be used, to pass through params to the Zabbix API.
     * For more informations about this params, check the Zabbix API
     * Documentation.
    ...
    public function triggerexpressionCheckFunction($params=array(), $arrayKeyProperty='')
    {
        // get params array for request
        $params = $this->getRequestParamsArray($params);

        // request
        return $this->request('triggerexpression.checkFunction', $params, $arrayKeyProperty);
    }
    
    /**
     * @brief   Reqeusts the Zabbix API and returns the response of the API
     *          method triggerexpression.checkSimpleExpression.
     *
     * The $params Array can be used, to pass through params to the Zabbix API.
     * For more informations about this params, check the Zabbix API
     * Documentation.
    ...
    public function triggerexpressionCheckSimpleExpression($params=array(), $arrayKeyProperty='')
    {
        // get params array for request
        $params = $this->getRequestParamsArray($params);

        // request
        return $this->request('triggerexpression.checkSimpleExpression', $params, $arrayKeyProperty);
    }
